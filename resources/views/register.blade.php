...
<head>
    ...
    <title>Daftar - Toko Kue Kharisma</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="register-container">
        ...
        <p class="welcome-text">DAFTAR SEKARANG</p>
        ...
        <div class="form-card">
            <form action="{{ route('register.submit') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control no-icon" placeholder="Masukkan nama anda" value="{{ old('name') }}" required>
                    @error('name')
            ...
            <div class="social-login">
                ...
                <div class="social-btn" onclick="registerWithFacebook()">
    ...
    <script>
        ...
        function registerWithFacebook() {
            alert('Daftar dengan Facebook akan segera tersedia');
        }

        function registerWithApple() {
            alert('Daftar dengan Apple akan segera tersedia');
        }
    </script>
</body>
</html>
